...
Tout échange avec le LLM a été documenté de manière transparente dans [agents.md](../doc/agents.md). Les prompts, les dates ainsi que les réponses du LLM y figurent. Toutefois, pour des échanges plus longs et plus avancés, je n'ai pas structuré les échanges en prompt-réponse, mais j'ai simplement copié-collé l'échange entier. J'ai également été transparente sur le site web en déclarant avoir utilisé un LLM pour la conception du site et de la carte.
